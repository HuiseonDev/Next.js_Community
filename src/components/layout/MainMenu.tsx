  ...
  return (
    <div className="w-auto order-2 text-base mt-4 md:mt-0">
      <ul className="flex items-center gap-6 uppercase">
        <li
          className={`hover:text-amber-500 hover:font-semibold ${isActive("/info")}`}
        >
          <Link href="/info">정보공유</Link>
        </li>
        <li
          className={`hover:text-amber-500 hover:font-semibold ${isActive("/free")}`}
        >
        ...
        <li
          className={`hover:text-amber-500 a:font-semibold ${isActive("/notice")}`}
        >

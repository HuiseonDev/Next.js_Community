  ...
  return (
    <main className="container mx-auto mt-10 p-4 transition-color">
      <section className="text-center">
        ...
        <Link
          href="/"
          className="bg-main text-white px-6 py-3 rounded hover:bg-sub"
        >
          커뮤니티 참여하기
        </Link>
      </section>
      ...
      <section className="mt-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded shadow dark:bg-gray-800">
            ...
            <Link href="/info" className="text-sub font-bold hover:underline">
              바로가기
            </Link>
          </div>
          <div className="bg-white p-6 rounded shadow dark:bg-gray-800">
            ...
            <Link href="/free" className="text-sub font-bold hover:underline">
              바로가기
            </Link>
          </div>
          <div className="bg-white p-6 rounded shadow dark:bg-gray-800">
            ...
            <Link href="/qna" className="text-sub font-bold hover:underline">
              바로가기
            </Link>
          </div>
        </div>
